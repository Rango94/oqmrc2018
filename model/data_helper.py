...
class data_helper_1:
    ...
    def __init__(self,config):
        ...
        self.max_len_al=config['max_len_alternatives']
    ...
    def next_batch(self,size):
        ...
        while size>0:
            ...
            query_single,query_single_len=self.normal_data([int(i) for i in line_json['query'].split(' ')],self.max_len_query)
            passage_single,passage_single_len=self.normal_data([int(i) for i in line_json['passage'].split(' ')],self.max_len_passage)
            ...
            for idx, each in enumerate(alternative_single):
                ...
                alternative.append(sub_alternative_single)
                alternative_len.append(sub_alternative_single_len)
    ...
    def get_test_data(self):
        ...
        while True:
            ...
            if line=='':
                ...
                break
            line_json = json.loads(line)
            query_single, query_single_len = self.normal_data([int(i) for i in line_json['query'].split(' ')],max_len=self.max_len_query)
            query.append(query_single)
            query_len.append(query_single_len)
