...
class data_helper:
    ...
    def __init__(self):
        ...
        self.test_file_fo=open(self.train_file_path,'r',encoding='utf-8')
    ...
    def next_batch(self,size):
        ...
        while size>0:
            ...
            for idx, each in enumerate(alternative_single):
                sub_alternative_single, sub_alternative_single_len = self.normal_data(each, 10)
...
if __name__=='__main__':
    dh=data_helper()
    print(dh.next_batch(100)['alternative'])
